package com.irisa.swpatterns.measures.test;
...
public class TestingMeasures {
	...
	private static Logger logger = Logger.getLogger(TestingMeasures.class);
						...
						if (outputComparisonResultsFile == null){						
							...
							if (!outputFile.exists()) {
								...
								try (FileWriter fw = new FileWriter(outputFile); 
									...
									out.println("input;other;Conversion;refCompressionRatioOwnCT;evalCompressionRationOwnCT;relativeCompressionRatio(withCT);newRelativeCompressionRatio;keepingDistrib;woDistrib;CTsimilarity");
									out.flush();
								}
								catch( Exception e) {
									e.printStackTrace();
